...
// אימפורטים של התמונות החדשות - אחוזת אלמוג
  ...
  return (
    <div className={styles.secondScreenContainer}>
      <div className={styles.titleContainer}>
        <span className={styles.titleEnglish}>Projects</span>
...
עם חיוך, חוצפה טובה וסטייל שאי אפשר להתעלם ממנו.</div>
      ...
      <div className={styles.description}>חשוב לי שתהיה לכם וודאות לגבי התהליך לפני שנדבר, סיכמתי עבורכם בכמה מילים איך תהליך העבודה איתי קורה</div>
      <Steps/> */}
