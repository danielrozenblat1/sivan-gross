      ...
      <section ref={containerRef} className={styles.section} id="מי-אני">
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            <h3 className={`${styles.name} ${styles.revealItem}`}>נעים להכיר, סיון גרוס</h3>
            
            <p className={`${styles.quote} ${styles.revealItem}`}>
              סטודיו בוטיק יוקרתי לתכנון ועיצוב פנים, המתמחה בליווי לקוחות פרטיים ועסקיים משלב הרעיון הראשוני ולכל אורכו
            </p>
        ...
        <div className={`${styles.storySection} ${styles.revealItem}`}>
          <div className={styles.storyContent}>
            <p className={styles.storyParagraph}>
              <span className={styles.storyHighlight}>אני לא רק מעצבת פנים - אני חיה ונושמת עיצוב נולדתי אל תוך עולם של יופי, סדר ויצירה.</span> בבית שגדלתי בו, אסתטיקה לא הייתה מילה נרדפת לעיצוב - היא הייתה דרך חיים. אמא, perfectionist של ניקיון ודיוק ותחושת מרחב, ואבא שתמיד שיפץ, בנה, הוסיף עוד חדר או שתל פרח חדש בגינה. אני זוכרת את עצמי כילדה הגדלה במושב יושבת מהצד, בולעת כל תנועה, שואלת שאלות, לוקחת חלק - בלי להבין ששם בדיוק נרקמה התשוקה שלי לעיצוב פנים.
            </p>
            <p className={styles.storyParagraph}>
